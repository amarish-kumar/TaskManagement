    ...
    public partial class InitialDb : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        TaskStatusId = c.Short(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        TaskStatusId = c.Short(nullable: false, identity: true),
                        TaskStatusName = c.String(nullable: false, maxLength: 20),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserTasks", "TaskStatusId", "dbo.TaskStatus");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.UserTasks", new[] { "TaskStatusId" });
